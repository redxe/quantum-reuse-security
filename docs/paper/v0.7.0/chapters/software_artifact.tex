...
reproduces all branch probabilities and reduced states at the parametric level
and is gated by a permanent CI job.
...
\begin{enumerate}
  ...
  \item run the Qiskit parametric parity suite on Python 3.11, confirming that
  the Qiskit Statevector backend agrees with NumPy across 43 parametric cases
  and one end-to-end CSV artifact comparison.
\end{enumerate}
