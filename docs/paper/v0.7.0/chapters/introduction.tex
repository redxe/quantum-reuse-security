...
\begin{enumerate}[leftmargin=1.8em]
  ...
  \item It organizes the threat space into a hyperlinked capability matrix that
  distinguishes direct feasibility, probabilistic or disturbance-limited
  alternatives, formal no-go boundaries, and project-specific contributions.
