...
\begin{itemize}
  ...
  \item It does not yet provide complete branch-level Qiskit parity across all
  configurations (Issue 13); parametric parity across 44 test cases is
  established by the current artifact.
  \item It does not prove victim-channel preservation as a formal channel
  theorem. The parametric sweep is strong numerical evidence but does not
  cover states entangled with an external reference; a Choi-state test would
  be needed for complete channel equality.
