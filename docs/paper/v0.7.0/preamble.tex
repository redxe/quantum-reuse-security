...
% Matrix colors are deliberately pale and paired with explicit text badges so
% that color is never the only carrier of meaning.
\definecolor{RiskGreen}{HTML}{177245}
\definecolor{RiskGreenSoft}{HTML}{E8F5EC}
\definecolor{RiskAmber}{HTML}{A85D00}
\definecolor{RiskAmberSoft}{HTML}{FFF2D8}
\definecolor{RiskBlue}{HTML}{2457C5}
\definecolor{RiskBlueSoft}{HTML}{EAF1FF}
\definecolor{RiskRed}{HTML}{A63B3B}
\definecolor{RiskRedSoft}{HTML}{FBEAEA}
\definecolor{RiskGray}{HTML}{59616B}
\definecolor{RiskGraySoft}{HTML}{F0F2F4}
...
\hypersetup{
  ...
  pdfsubject={Quantum compilation, qubit reuse, information flow, security capability matrix, and verification}
}
...
% Hyperlinked security capability matrix helpers.
\newcommand{\riskbadge}[2]{%
  \tikz[baseline=(n.base)]\node[rounded corners=1.3pt,inner xsep=3pt,
  inner ysep=1pt,fill=#1!12,draw=#1!75,text=#1!85!black,
  font=\tiny\bfseries] (n) {#2};%
}
\newcommand{\ourresult}{\textsuperscript{\ensuremath{\bigstar}}}
\newcommand{\candidatepriority}{\textsuperscript{\ensuremath{\ddagger}}}
\newcommand{\workaround}{\textsuperscript{\ensuremath{\hookrightarrow}}}
\newcommand{\strongaccess}{\textsuperscript{\ensuremath{\dagger}}}
\newcommand{\nogo}{\textsuperscript{\ensuremath{\varnothing}}}
\newcommand{\mitigation}{\textsuperscript{\textsf{M}}}
\newcommand{\matrixback}{\hyperlink{matrix:overview}{\textcolor{AccentBlue}{\scriptsize$\lhd$ Back to matrix}}}
\newcommand{\matrixsummary}[5]{%
  \cellcolor{#2}%
  \begin{minipage}[t][2.02cm][t]{\linewidth}
    \textbf{\hyperlink{cell:#1}{#1}}\hfill #3\\[-1pt]
    \raggedright\scriptsize #4\par
    \vfill\raggedleft\scriptsize #5
  \end{minipage}%
}
\newtcolorbox{matrixrecord}[2][]{
  enhanced,colback=#2,colframe=black!35,boxrule=0.45pt,arc=1.4pt,
  left=6pt,right=6pt,top=5pt,bottom=5pt,before skip=5pt,after skip=5pt,
