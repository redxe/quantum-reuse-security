...
\cref{sec:threat-model,sec:defenses,sec:research-agenda} develop the systems
implications. The appendices collect resource counts, reproducibility details,
the software artifact, and the questions that remain open before submission.
...
This is Research Draft 0.6. It combines symbolic derivations, supplied Quirk
